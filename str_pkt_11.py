...
class str_pkt_11(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "str_pkt_11", catch_exceptions=True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\jarab\\Desktop\\padded.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\jarab\\Desktop\\Output.txt', False)
...
def main(top_block_cls=str_pkt_11, options=None):
    tb = top_block_cls()
